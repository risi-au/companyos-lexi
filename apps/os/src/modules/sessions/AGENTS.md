...
## Files
- `SessionsView.tsx`: client component with status and scope-path filters. Renders scope, title, engine/model, status, stale flag, heartbeat age, and worktree reference.
