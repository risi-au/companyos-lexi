...
## Files
- `WorkLogView.tsx`: client component with kind, since preset, and scope-path filters. Renders scope path, kind, title, source badge for GitHub-created records, and date in a compact table.
