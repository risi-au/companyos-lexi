...
- Document search excludes legacy operational wiki-report pages using the shared documents predicate from `@companyos/db`; authorized direct document retrieval remains available in the docs module.
